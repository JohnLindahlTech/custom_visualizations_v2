...
const vis: SunburstVisualization = {
  ...
  update(data, element, config, queryResponse) {
    ...
    const partition = d3
      .partition<{ name: string; children: any[]; depth: number }>()
    ...
    svg
      ...
      .on("click", function (e: any, d: any) {
        const event: object = { pageX: e.pageX, pageY: e.pageY };
      ...
      .on("mouseenter", (d: any) => {
        ...
        svg.selectAll("path").style("fill-opacity", (p: any) => {
